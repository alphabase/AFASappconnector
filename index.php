...
<body>
	...
	<div class="container">
		<h1>
			<a href="<?php echo $_SERVER['PHP_SELF']?>">AFAS AppConnector</a>
		</h1>
		<p class="lead">Lorem ipsum dolor sit amet, consectetur adipiscing
			elit. Suspendisse felis.</p>
					...
					<div class="panel panel-info">
						...
						<div class="panel-body">
							<div class="form-group">
								<label for="userId">Username</label> <input type="text"
									class="form-control" id="userId" name="userId"
									placeholder="userId" value="<?php echo $_SESSION['userId']?>" />
							</div>
							<div class="form-group">
								<label for="otp">One Time Password</label> <input type="number"
									class="form-control" name="otp" id="otp" placeholder="otp"
									autofocus />
							</div>
						...
						<div class="panel-body">
							<div class="form-group">
								<label for="token">Token</label> <input type="text"
									...
									placeholder="token" value="<?php echo $_SESSION['token']?>" />
							</div>
							<div class="form-group">
								<label for="connectorId">GetConnector</label> <input type="text"
									class="form-control" name="connectorId" id="connectorId"
									placeholder="connectorId"
									value="<?php echo (isset($_REQUEST['connectorId'])) ? $_REQUEST['connectorId'] : 'ProfitCountries'?>" />
							</div>
							<div class="form-group">
								<label for="filtersXml">Filter</label>
								<textarea class="form-control" id="filtersXml" name="filtersXml"
									placeholder="filtersXml"><?php echo (isset($_REQUEST['filtersXml'])) ? $_REQUEST['filtersXml'] : ''?></textarea>
							</div>
							<div class="row">
								<div class="col-xs-6">
									<div class="form-group">
										<label for="skip">Skip</label> <input type="number"
											class="form-control" name="skip" id="skip" placeholder="skip"
											value="<?php echo (isset($_REQUEST['skip'])) ? $_REQUEST['skip'] : 0?>" />
									</div>
								</div>
								<div class="col-xs-6">
									<div class="form-group">
										<label for="take">Take</label> <input type="number"
											class="form-control" name="take" id="take" placeholder="take"
											value="<?php echo (isset($_REQUEST['take'])) ? $_REQUEST['take'] : 10?>" />
									</div>
								</div>
							</div>
					...
					<div class="panel panel-info">
						...
						<div class="panel-body">
							...
							<div class="row">
								<div class="col-xs-9">
									<div class="form-group">
										<label for="connectorType">UpdateConnector</label> <input
											type="text" class="form-control" name="connectorType"
											id="connectorType" placeholder="connectorType"
											value="<?php echo (isset($_REQUEST['connectorType'])) ? $_REQUEST['connectorType'] : 'KnPerson'?>" />
									</div>
								</div>
								<div class="col-xs-3">
									<div class="form-group">
										<label for="connectorVersion">Version</label> <input
											type="number" class="form-control" name="connectorVersion"
											id="connectorVersion" placeholder="connectorVersion"
											value="<?php echo (isset($_REQUEST['connectorVersion'])) ? $_REQUEST['connectorVersion'] : 1?>" />
									</div>
								</div>
							</div>
							<div class="form-group">
								<label for="dataXml">XML data</label>
								<textarea class="form-control" id="dataXml" name="dataXml"
									placeholder="dataXml"><?php echo (isset($_REQUEST['dataXml'])) ? $_REQUEST['dataXml'] : ''?></textarea>
							</div>
				...
				<div class="panel panel-danger">
					<div class="panel-heading" role="tab">
						<h2 class="panel-title">
							<a role="button" data-toggle="collapse" href="#collapseError"
								role="tabpanel">Error</a>
						</h2>
					</div>
					<div class="panel-collapse collapse in" id="collapseError">
						<div class="panel-body">
...
<?php endif?>
				<div class="panel panel-info">
					<div class="panel-heading" role="tab">
						<h2 class="panel-title">
							<a role="button" data-toggle="collapse" href="#collapseSession"
								role="tabpanel">Session</a>
						</h2>
					</div>
...
<?php if (is_array($_REQUEST) && count($_REQUEST) > 0):?>
			<div class="panel panel-info">
					<div class="panel-heading" role="tab">
						<h2 class="panel-title">
							<a role="button" data-toggle="collapse" href="#collapseRequest"
								role="tabpanel">Request</a>
						</h2>
					</div>
...
<?php if (isset($response)):?>
			<div class="panel panel-info">
					<div class="panel-heading" role="tab">
						<h2 class="panel-title">
							<a role="button" data-toggle="collapse" href="#collapseResponse"
								role="tabpanel">Response</a>
						</h2>
					</div>
...
<?php endif?>
			<div class="panel panel-info">
					<div class="panel-heading" role="tab">
						<h2 class="panel-title">
							<a role="button" data-toggle="collapse"
								href="#collapseAppConnector" role="tabpanel">AppConnector</a>
						</h2>
					</div>
				...
				<div class="panel panel-info">
					<div class="panel-heading" role="tab">
						<h2 class="panel-title">
							<a role="button" data-toggle="collapse" href="#collapseServer"
								role="tabpanel">Server</a>
						</h2>
					</div>
